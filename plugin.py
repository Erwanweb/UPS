    ...
    def onHeartbeat(self):
        ...
        if self.CURRENT >= -150:
            ...
            if self.BatteryLevel > 0:
                ...
                Domoticz.Log("Power Failure - Battery is discharging, Battery Level is undefined - Please wait for calculation")
                Devices[2].Update(nValue=4, sValue="Power Failure - undef. Batt. Level, wait for calculation")
