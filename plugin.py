    ...
    def onHeartbeat(self):
        ...
        if self.CURRENT >= -150:
            ...
            if self.PERCENT >= 98:
                ...
                Devices[2].Update(nValue=2, sValue="Power supply ok - Battery charging - {} %".format(self.BatteryLevel))
                if self.BatteryLevel > 0:
                    Domoticz.Log("Power supply is OK, Battery is charging, Battery Level is now at {} %".format(self.BatteryLevel))
                else :
                    Domoticz.Log("Power supply is OK, Battery is charging, attery Level is undefined - Please wait for calculation")
            ...
            Devices[2].Update(nValue=4, sValue="Power supply DOWN - Battery discharging - {} %".format(self.BatteryLevel))
            if self.BatteryLevel > 0:
