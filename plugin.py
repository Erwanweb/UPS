...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if len(UPSReadedValues) == 4:
            ...
            Domoticz.Debug("UPS Values are : Voltage {} mV, Current {} mA, Power {} mW, Battery Level {} %, Calc. remaining time {} minutes".format(self.VOLTAGE, self.CURRENT, self.POWER, self.PERCENT, self.TIMEMIN))
        else:
