...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if len(UPSReadedValues) == 4:
            ...
            Domoticz.Debug("Time remaining on Batt. is : Voltage {} H {} Mins".format(LastRemainTime.strftime("%-H", gmtime(LastRemainTime)), LastRemainTime.strftime("%-H", gmtime(LastRemainTime))))
        else:
