...
def read(ina219, parameter):
    ...
    if (voltage *1000) > 8000)): percent = (voltage - 6)/2.25*100 # base : percent = (voltage - 6)/2.25*100 - base WS2.4
    elif (voltage *1000) < 8000)) and (voltage *1000) > 7500)): percent = (voltage - 6)/2.3*100 # base : percent = (voltage - 6)/2.25*100 - base WS2.4
    elif (voltage * 1000) < 7500)) and (voltage * 1000) > 7200)): percent = (voltage - 6)/2.35 * 100  # base : percent = (voltage - 6)/2.25*100 - base WS2.4
